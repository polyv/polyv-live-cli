...
describe('live interaction command registration', () => {
  ...
  it('registers read/list command surfaces for live_interaction gaps', () => {
    const commands = [
      ...
      findCommand(program, ['questionnaire', 'list']),
      findCommand(program, ['questionnaire', 'result-list']),
      ...
      findCommand(program, ['lottery', 'group', 'list']),
      findCommand(program, ['lottery', 'group-viewer', 'list']),
      findCommand(program, ['lottery', 'blacklist', 'list']),
      findCommand(program, ['lottery', 'lucky-bag', 'winners']),
      findCommand(program, ['interaction', 'webhook', 'get']),
      findCommand(program, ['interaction', 'event', 'list']),
      findCommand(program, ['interaction', 'script', 'query']),
      findCommand(program, ['interaction', 'task-reward', 'list']),
      findCommand(program, ['interaction', 'task-reward', 'stats']),
      findCommand(program, ['interaction', 'task-reward', 'viewer-detail']),
      findCommand(program, ['interaction', 'task-reward', 'viewer-list']),
    ];
  ...
  it('adds force protection to live_interaction write command surfaces', () => {
    const commands = [
      ...
      findCommand(program, ['lottery', 'create']),
      findCommand(program, ['lottery', 'update']),
      findCommand(program, ['lottery', 'delete']),
      findCommand(program, ['lottery', 'receive-info']),
      findCommand(program, ['lottery', 'wait', 'create']),
      findCommand(program, ['lottery', 'group', 'create']),
      findCommand(program, ['lottery', 'group', 'update']),
      findCommand(program, ['lottery', 'group', 'delete']),
      findCommand(program, ['lottery', 'group-viewer', 'add']),
      findCommand(program, ['lottery', 'group-viewer', 'add-names']),
      findCommand(program, ['lottery', 'group-viewer', 'delete']),
      findCommand(program, ['lottery', 'blacklist', 'add']),
      findCommand(program, ['lottery', 'blacklist', 'delete']),
      ...
      findCommand(program, ['interaction', 'event', 'save']),
      findCommand(program, ['interaction', 'event', 'delete']),
      findCommand(program, ['interaction', 'invite-poster', 'create']),
      findCommand(program, ['interaction', 'script', 'upload']),
      findCommand(program, ['interaction', 'script', 'delete']),
      findCommand(program, ['interaction', 'task-reward', 'create']),
      findCommand(program, ['interaction', 'task-reward', 'update']),
      findCommand(program, ['interaction', 'task-reward', 'delete']),
      findCommand(program, ['interaction', 'task-reward', 'stop']),
      findCommand(program, ['interaction', 'task-reward', 'submit-accept-info']),
    ];
