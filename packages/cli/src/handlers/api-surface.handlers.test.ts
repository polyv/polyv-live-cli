...
describe('API surface handlers', () => {
  ...
  it('executes cross-cutting interaction operations', async () => {
    ...
    const cases: Array<[string, string, Record<string, unknown>]> = [
      ...
      ['saveInteractionEvent', 'saveInteractionEvent', { channelId: 'ch1', eventType: 'vote', eventData: { title: 'Vote' } }],
      ['deleteInteractionEvent', 'deleteInteractionEvent', { channelId: 'ch1', eventId: 'evt1' }],
