...
| 4 | `channel` | 01、02 | ✅ 已执行成功 | 7983877 / 7983883 | [01](./01-coupon-redemption.md)、[02](./02-product-card-push.md) |
| 5 | `chat` | — | ⬜ 未覆盖 | — | — |
| 6 | `checkin` | — | ⬜ 未覆盖 | — | — |
